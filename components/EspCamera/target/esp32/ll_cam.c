...
esp_err_t ll_cam_set_pin(cam_obj_t *cam, const camera_config_t *config)
{
    ...
    io_conf.intr_type = cam->vsync_invert ? GPIO_INTR_NEGEDGE : GPIO_INTR_POSEDGE;
...
static bool ll_cam_calc_rgb_dma(cam_obj_t *cam){
    ...
    ESP_LOGI(TAG, "node_size: %4lu, nodes_per_line: %lu, lines_per_node: %lu, dma_half_buffer_min: %5lu, dma_half_buffer: %5lu, lines_per_half_buffer: %2lu, dma_buffer_size: %5lu, image_size: %lu", (unsigned long)(node_size * cam->dma_bytes_per_item), (unsigned long)nodes_per_line, (unsigned long)lines_per_node, (unsigned long)(dma_half_buffer_min * cam->dma_bytes_per_item), (unsigned long)(dma_half_buffer * cam->dma_bytes_per_item), (unsigned long)lines_per_half_buffer, (unsigned long)(dma_buffer_size * cam->dma_bytes_per_item), (unsigned long)image_size);
